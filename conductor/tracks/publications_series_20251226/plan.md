...
- [x] Task: Create Publication Folder Hierarchy (spec 2.1) [45c25a5]
    - [ ] Sub-task: Create `publications/shared/references` & commit
    - [ ] Sub-task: Create `publications/shared/author_guidelines` & commit
    - [ ] Sub-task: Create `publications/P1_Qualitative_MJA/{01_Protocol,02_Analysis,03_Manuscript}` & commit
    - [ ] Sub-task: Create `publications/P2_Modelling_MJA/{01_Protocol,02_Analysis,03_Manuscript}` & commit
    - [ ] Sub-task: Create `publications/P3_RACMA_Position/{01_Drafting,02_Final}` & commit
- [ ] Task: Tooling - Reference Manager (Enhanced)
    - [ ] Sub-task: Implement `scripts/pub_tools/manage_refs.py` (DOI/URL Enforcement) & commit
    - [ ] Sub-task: Implement Recency Checker (Warn if > 10 years old) & commit
    - [ ] Sub-task: Implement Quality Heuristic (Check Journal against High Impact List) & commit
    ...
    - [ ] Sub-task: Verify tool with test case & commit
