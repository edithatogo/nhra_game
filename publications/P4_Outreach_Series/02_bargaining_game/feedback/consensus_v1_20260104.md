...
1) Strengthen LinkedIn post hook (question format + punchy line).
2) Add one sentence acknowledging that equilibria can differ (sometimes multiple), without adding math.

### P2 (could do)

1) Add 1–2 bullets linking uncertainty to frontline planning (workforce, service planning), with a patient-impact line.
