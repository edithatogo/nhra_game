...
The sequential structure of activity submission is illustrated in Figure 1.

**Figure 1: Simplified Extensive Form Game Tree: The Activity Submission Action Situation**
[Mermaid Diagram Representation: LHN observes state -> chooses strategy (Honest vs. Gaming) -> Regulator observes signal -> chooses audit strategy -> Payoffs realized]
