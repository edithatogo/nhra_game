...
- Adds v19 outputs pipeline (run_v19_all, plots, report) including: full stage-game equilibria by year, macro drift plots (NEP vs costs), intervention packages, and a D3 interactive network view driven by scenario time series.
