...
from nhra_gt.engine import Params, baseline_state, decide_strategies, step


def animate_pressure(
    n_mc: int = 50, n_years: int = 10, output_path: str = "outputs/animations/pressure_swarm.gif"
):
