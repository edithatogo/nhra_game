...
from nhra_gt.visualization.interactive import plot_vfi_waterfall, plot_phase_space
...
def generate_brief(scenario_name: str, output_path: Path):
    ...
    story.append(Paragraph("The waterfall above decomposes the 'leakage' between policy commitment and operational reality.", styles["Italic"]))
    story.append(Spacer(1, 12))
    ...
    story.append(Paragraph("The phase-space trajectory highlights the relationship between pressure and occupancy, indicating potential recovery paths from crisis modes.", styles["Italic"]))
    story.append(Spacer(1, 12))
