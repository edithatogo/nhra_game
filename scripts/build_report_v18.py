...
def main() -> None:
    ...
    md: list[str] = []
    md.append("# NHRA game-theory mechanism simulation — v18 report (2025–2030)")
    md.append("")
    md.append("**Date:** 21 Dec 2025  \
**Version:** v18 (Round 2 implementation)  \
**Purpose:** Provide decision-relevant outputs for RACMA policy positioning. This is a **stylised mechanism model** intended to clarify incentive structures and plausible directions of effect, not to generate point forecasts.")
    ...
    md.append("")
    md.append("The model uses several 2×2 stage games (definition, bargaining, cost shifting, discharge coordination, governance integration, compliance). For transparency, v18 exports **all Nash equilibria** (pure + mixed) by year at the mean system state.")
    md.append("")
