...
from nhra_gt.engine import Params as ParamsNp, run_hybrid as run_hybrid_np
from nhra_gt.engine_jax import ParamsJax, StateJax, run_simulation_jax, baseline_state_jax
...
def benchmark():
    ...
    _ = run_hybrid_np(years, p_np, n_mc=n_mc, seed=42)
    ...
    # Warmup
    _ = jax.jit(run_simulation_jax, static_argnums=(4,))(sj, pj, strat, key, num_months)
    ...
    report_path.write_text(f"""# Performance Modernization Report
Date: 2025-12-27
