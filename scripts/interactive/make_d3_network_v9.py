...
def main() -> None:
    ...
    out = repo / "outputs" / "v9" / "interactive"
    ...
    (out / "games_network_v9.json").write_text(json.dumps(graph, indent=2), encoding="utf-8")
    ...
    (out / "scenario_timeseries_v9.json").write_text(json.dumps(series, indent=2), encoding="utf-8")
